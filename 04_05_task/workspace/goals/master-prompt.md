...
Do not solve the task yourself. The goal is to write an agentic loop or agent workflow or agentic system that will solve the task. It should be able to solve it again if data changes.
